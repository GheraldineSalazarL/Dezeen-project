...
export const ApiContext = ({ children }) => {
    ...
    addProjects([
        ...
        {
            categoria:"Diseño",
            "desc-1":"La empresa de electrónica de consumo Sony y el fabricante de automóviles Honda han combinado su experiencia para producir un prototipo de automóvil eléctrico, que se presentó en el Consumer Electronics Show de esta semana. El sedán eléctrico, lanzado bajo la marca de automóviles recién lanzada Afeela de la empresa conjunta Sony Honda Mobility, fue diseñado para priorizar el entretenimiento y la interacción.",
            "desc-2":"Cuenta con interfaces desarrolladas por Epic Games y pantallas para películas, juegos e 'infoentretenimiento' instaladas tanto en el interior como en el exterior del automóvil. Los conductores podrán hacer uso de estas comodidades incluso cuando estén detrás del volante, ya que el automóvil está configurado para ofrecer una conducción autónoma guiada por una serie de 45 sensores y cámaras diferentes.",
            destacada:true,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fprimerauto%2Fprimerauto-1.png?alt=media&token=5d96682a-4a2a-4bca-b084-903c1720e3d0",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fprimerauto%2Fprimerauto-2.png?alt=media&token=6e6642db-b79b-4ec2-988e-eb4270573559",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fprimerauto%2Fprimerauto-3.png?alt=media&token=40e14c68-adbf-4268-ad09-a8768a359daf",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fprimerauto%2Fprimerauto-4.png?alt=media&token=2419ea86-a3d3-44b2-a131-297346121e3b",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fprimerauto%2Fprimerauto-5.png?alt=media&token=fcc7962d-e892-4c14-8d77-8f3665fac0d8",
            pais:"",
            subtitulo:"",
            tipo:"Por Jennifer Hahn",
            titulo:"Primer automóvil de Sony & Honda"
        },
        {
            categoria:"Diseño",
            "desc-1":"El diseñador Stephen Burks ha presentado cinco prototipos, incluidos podios para dispositivos digitales y una pantalla que promueve la privacidad, en una exposición retrospectiva en Atlanta, Georgia. Desarrollado por Burks en el apogeo de la pandemia de coronavirus, el Proyecto Shelter in Place es una serie de diseños que exploran nuevas formas de interactuar con el hogar en tiempos de crisis global.",
            "desc-2":"Los diseños se encuentran entre las 50 obras que se exhiben en una importante exhibición del trabajo del diseñador, también llamada Shelter in Place, en el High Museum of Art de Atlanta. Burks los describe como 'experimentos divertidos para adaptarse a los cambios cotidianos que nos trajo esta nueva forma de vida'.",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fglobalcrisis%2Fglobalcrisis-1.png?alt=media&token=0985c64c-be99-4a01-aab9-0cf6af9609e6",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fglobalcrisis%2Fglobalcrisis-2.png?alt=media&token=4ac17380-d2fe-482d-89bb-e8c60edac604",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fglobalcrisis%2Fglobalcrisis-3.png?alt=media&token=f062718f-146c-4e25-9efd-cb2b3639bf7c",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fglobalcrisis%2Fglobalcrisis-4.png?alt=media&token=ca890675-572c-4057-b4bf-28c2d5d0c2c5",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fglobalcrisis%2Fglobalcrisis-5.png?alt=media&token=5d890ba2-294e-484d-9db7-541b2d780cb5",
            pais:"",
            subtitulo:"",
            tipo:"Por Amy Frearson",
            titulo:"Stephen Burks presenta “Global crisis” en el Museo de Arte"
        },
        {
            categoria:"Diseño",
            "desc-1":"El diseñador británico Paul Cocksedge ha creado Loop, una gran escultura hecha de acero y tela metálica que cuelga del techo del edificio de oficinas de Londres The Rowe. La instalación de arte, que fue diseñada para ocupar el vestíbulo del edificio de forma creativa, consta de grandes bucles de acero y tejido metálico que alcanzan hasta 5,5 metros de longitud.",
            "desc-2":"El diseño de Loop, que se asemeja a una sola pieza delgada de tela metálica, se basó en el área que rodea The Rowe. El desarrollo está ubicado en Whitechapel, al este de Londres, un vecindario culturalmente diverso que solía ser conocido por su fabricación de ropa y textiles.",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Finstalacionloop%2Finstalacionloop-1.png?alt=media&token=fa4a1a34-2dbe-46dc-a8b8-f5d9d780d17d",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Finstalacionloop%2Finstalacionloop-2.png?alt=media&token=54884f7c-171c-4194-80ff-745c49449d52",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Finstalacionloop%2Finstalacionloop-3.png?alt=media&token=28090828-7518-412d-a31a-929cbf07a7d5",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Finstalacionloop%2Finstalacionloop-4.png?alt=media&token=41c56e43-47d3-42ea-898f-b852ba850efb",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Finstalacionloop%2Finstalacionloop-5.png?alt=media&token=0b162dc2-7be7-4723-b625-f690f2fdd297",
            pais:"Londres",
            subtitulo:"Paul Cocksedge",
            tipo:"Instalación - Escultura",
            titulo:"Instalación Loop"
        },
        {
            categoria:"Diseño",
            "desc-1":"A medida que la crisis energética global arrojó luz sobre la dependencia de los combustibles fósiles este año, continuamos nuestra revisión de 2022 analizando 10 de los proyectos más innovadores que demuestran formas más renovables, eficientes y asequibles de alimentar nuestras vidas. Después de que la guerra de Rusia en Ucrania hizo que los costos de la energía se dispararan a niveles récord, los diseñadores y arquitectos argumentaron que ahora es el momento de duplicar la transición a la energía renovable.",
            "desc-2":"'Este es un momento crucial en el que necesitamos cambiar nuestras sociedades hacia un camino más seguro', dijo el arquitecto Michael Pawlyn a Dezeen a principios de este año. Desde una batería de arena hasta una turbina eólica portátil y una manta calentada por energía solar de bajo costo, aquí hay 10 proyectos cubiertos en Dezeen en 2022 que demuestran cómo se puede hacer:",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftop10%2Ftop10-1.png?alt=media&token=a9a1240c-2115-4452-8c86-94bca6d9c711",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftop10%2Ftop10-2.png?alt=media&token=1bc862ff-2b69-4bd0-82ac-0d96a3f9158f",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftop10%2Ftop10-3.png?alt=media&token=8043a4e2-582a-45f3-8c13-a0bbc51b75b0",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftop10%2Ftop10-4.png?alt=media&token=eb2f5301-4305-4fa1-9c0a-d8a4a7635d14",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftop10%2Ftop10-5.png?alt=media&token=a872f845-738e-43a8-aead-dd9fc83d8116",
            pais:"",
            subtitulo:"",
            tipo:"Por Jennifer Hahn",
            titulo:"Top 10 diseños de Dezeen: ¿Cómo usamos la energía?"
        },
        {
            categoria:"Diseño",
            "desc-1":"Desde asientos con formas orgánicas redondeadas hasta iluminación diseñada por Frank Lloyd Wright, aquí hay 12 diseños de muebles y productos de interior hechos de madera presentados en Dezeen Showroom. La madera se ha utilizado para fabricar muebles durante miles de años debido a que es versátil, duradera y fácil de conseguir.",
            "desc-2":"Como material renovable con bajo contenido de carbono incorporado, la madera es una opción de material sostenible popular entre los diseñadores. Tiene una atractiva veta natural que cambia de tono y patrón según la especie del árbol, y puede dejarse en su estado natural o tratarse con pinturas y barnices. Este resumen presenta muebles hechos de varios tipos de madera, incluidos abeto de Douglas, cerezo, roble, nogal, haya, arce y madera de acacia.",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fdise%C3%B1osmadera%2Fdise%C3%B1osmadera-1.png?alt=media&token=80e9c866-2510-4d8e-ae01-a930b227a8f4",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fdise%C3%B1osmadera%2Fdise%C3%B1osmadera-2.png?alt=media&token=9d23e295-ab8a-4740-b433-04282dc53764",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fdise%C3%B1osmadera%2Fdise%C3%B1osmadera-3.png?alt=media&token=e8a41fcd-8046-483f-b95c-7365bc9ae17e",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fdise%C3%B1osmadera%2Fdise%C3%B1osmadera-4.png?alt=media&token=ba941a09-ce09-430e-8ad6-85d502f7d1b5",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fdise%C3%B1osmadera%2Fdise%C3%B1osmadera-5.png?alt=media&token=a253f622-a6af-443d-89f3-be6947174a78",
            pais:"",
            subtitulo:"",
            tipo:"Por Alice Laycock",
            titulo:"Diseños en madera que muestran el valor del material."
        },
        {
            categoria:"Catálogo",
            "desc-1":"Diseñada por APE Amsterdam para la marca de iluminación holandesa Humble Lights, la lámpara Two es una fuente de luz regulable, portátil y recargable que tiene como objetivo proporcionar una alternativa conveniente y segura al brillo íntimo de una vela. Se puede utilizar tanto como luz de trabajo como ambiental, y a sus 10 colores se unen ahora dos nuevos tonos, el negro y el beige.",
            "desc-2":"Recientemente se presentaron dos lámparas en Dezeen Showroom, junto con una gama de moquetas modulares inspiradas en el mundo natural y un sofá de construcción propia que se puede personalizar cambiando sus fundas. Las lámparas están disponibles en tiendas físicas de Dezeen alrededor del Reino Unido. Para exportaciones tendrás que consultar la tienda en línea.",
            destacada:true,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftwolamp%2Ftwolamp-1.png?alt=media&token=b8c45d1f-b9f6-46fa-a613-33a58cc681c0",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftwolamp%2Ftwolamp-2.png?alt=media&token=f83321e1-5356-4b62-be34-bc8f58e53b4a",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftwolamp%2Ftwolamp-3.png?alt=media&token=4b46f0ea-4a3f-4f55-934e-cf3ccecb033c",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftwolamp%2Ftwolamp-4.png?alt=media&token=d3ce6a75-ab3e-40d1-a66b-b109992854ba",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftwolamp%2Ftwolamp-5.png?alt=media&token=3cf9989f-f208-4ad6-aa29-ba1af8d2df5c",
            pais:"Dezeen Showroom",
            subtitulo:"Humble Lights",
            tipo:"Luminarias",
            titulo:"Two lamp"
        },
        {
            categoria:"Catálogo",
            "desc-1":"La práctica de diseño e investigación Raw-Edges se asoció con la marca de muebles Cozmo Home para crear un sofá modular con fundas perfectamente intercambiables. El sofá Cozmo del mismo nombre de la marca tiene asientos profundos que están hechos de una combinación de pluma y espuma viscoelástica, que se pueden vestir con una selección de 'chaquetas' que se deslizan fácilmente sobre el asiento, el respaldo y los cojines dispersos.",
            "desc-2":"Cozmo Home's first collection of covers consists of jackets made from recycled cotton, pile fleece and velvet available in a spectrum of colours. This wide range of finish options creates more than 20 possible combinations for maximum customisation, according to the brand.",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fcozmosofa%2Fcozmosofa-1.png?alt=media&token=df94c949-9900-42cb-bf56-ee0c129ead52",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fcozmosofa%2Fcozmosofa-2.png?alt=media&token=dc3941a4-00eb-4fca-ab37-1c6197bea841",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fcozmosofa%2Fcozmosofa-3.png?alt=media&token=445c92ba-b09f-4dac-9175-073e1d18b828",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fcozmosofa%2Fcozmosofa-4.png?alt=media&token=b43ccde8-da4d-4c89-bb2b-8994d6bf0988",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fcozmosofa%2Fcozmosofa-5.png?alt=media&token=f1194000-51e7-4d81-a754-0078d3253df4",
            pais:"Cozmo Home",
            subtitulo:"Raw-Edges",
            tipo:"Mobiliario",
            titulo:"Cozmo sofa"
        ...
        {
            categoria:"Catálogo",
            "desc-1":"Foro es una mesa de roble que fue creada por el diseñador británico John Pawson para la marca española de muebles Viccarbe para reunir a las personas para comer y conversar. El diseño de la mesa Foro se basa en la antigua cultura de los foros romanos, donde la gente se reunía en el mercado para actividades sociales y financieras.",
            "desc-2":"Foro es una mesa de roble que fue creada por el diseñador británico John Pawson para la marca española de muebles Viccarbe para reunir a las personas para comer y conversar. El diseño de la mesa Foro se basa en la antigua cultura de los foros romanos, donde la gente se reunía en el mercado para actividades sociales y financieras.",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fnodaleto2%2Fnodaleto-1.png?alt=media&token=cac120d4-b2f7-4899-bf87-2f570a7f7764",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fnodaleto2%2Fnodaleto-2.png?alt=media&token=41b46a3e-9a36-48b2-ae21-95b9bba5a977",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fnodaleto2%2Fnodaleto-3.png?alt=media&token=c5a4d905-faf6-4055-a92d-64c896658f48",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fnodaleto2%2Fnodaleto-4.png?alt=media&token=bc50fc5a-d053-403c-810c-18a48b085646",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fnodaleto2%2Fnodaleto-5.png?alt=media&token=63d7f052-8609-47e5-9b52-4a0f92a72669",
            pais:"Miami",
            subtitulo:"Rafael Cárdenas",
            tipo:"Retail Design",
            titulo:"Nodaleto"
        ...
        {
            categoria:"Catálogo",
            "desc-1":"Para conmemorar el décimo aniversario de la marca, la empresa de interiores danesa OYOY Living Design ha lanzado una colección de edición limitada de recipientes de cerámica de arcilla. Toppu consta de un jarrón, un tazón, una maceta y una bandeja que tienen una variedad de usos, desde presentar y servir alimentos hasta contener plantas de interior.",
            "desc-2":"Los artículos, que varían en forma y escala según su uso previsto, están unidos por su acabado rayado, con bandas verticales alternas de blanco y gris suave. 'A diferencia de los diseños anteriores de Toppu, esta serie de edición limitada presenta un acabado más suave y natural, con un tono tierra, que le da un aspecto muy nórdico', dijo OYOY.",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftoppu%2Ftoppu-1.png?alt=media&token=deb6cb2b-f962-451b-ba94-996b9a09f472",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftoppu%2Ftoppu-2.png?alt=media&token=e5c4d15c-a8ec-4cbe-865c-3e56e7f81942",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftoppu%2Ftoppu-3.png?alt=media&token=5ba20dfb-6ef4-4880-a1d9-38396dacec17",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftoppu%2Ftoppu-4.png?alt=media&token=a13f46cf-005a-4ed1-b1a9-750fb4425ff6",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Ftoppu%2Ftoppu-5.png?alt=media&token=ae56d574-771e-4010-a1c7-bc84686b201f",
            pais:"OYOY Living Design",
            subtitulo:"Fernando Romero",
            tipo:"Objetos",
            titulo:"Toppu ceramics"
        },
        {
            categoria:"Catálogo",
            "desc-1":"La marca australiana Derlot ha colaborado con el diseñador Alexander Lotersztain en un sistema de asientos inspirado en las carreteras alemanas. Autobahn se diseñó originalmente en 2012 y tiene un formato modular, lo que permite que sus componentes se reconfiguren fácilmente para adaptarse a una variedad de espacios y funciones. El sistema se compone de módulos de asientos de banco rectos y curvos, que están diseñados para combinarse en una estructura larga y serpenteante.",
            "desc-2":"'Al igual que la autopista alemana, la colección Autobahn tiene que ver con líneas fluidas, espacios abiertos y un sinfín de posibilidades', dijo Derlot. 'Una forma refinada y minimalista permite a Autobahn cambiar de marcha sin esfuerzo y adaptarse tanto a entornos formales como informales'. Los asientos se pueden tapizar en una variedad de telas y pieles, y las patas y la mesa vienen en una selección de colores con recubrimiento en polvo y chapas de madera.",
            destacada:false,
            "foto-main-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fautoban%2Fautoban-1.png?alt=media&token=e1eb72cd-9a87-4f84-88ca-1d5a20f1cd19",
            "foto-main-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fautoban%2Fautoban-2.png?alt=media&token=f2bcb983-ea3e-4129-8849-893b8aa4f262",
            "foto-main-3":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fautoban%2Fautoban-3.png?alt=media&token=64c6d4ae-2ead-4fc1-a277-2e0563cae41d",
            "foto-extra-1":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fautoban%2Fautoban-4.png?alt=media&token=9da791c8-50f0-4e1d-8cc6-a695283fe2f9",
            "foto-extra-2":"https://firebasestorage.googleapis.com/v0/b/deezen-1a1d3.appspot.com/o/proyectos%2Fautoban%2Fautoban-5.png?alt=media&token=cf6d0f47-1e76-4b24-b39f-f9f50c602154",
            pais:"Alemania",
            subtitulo:"Alexander Lotersztain",
            tipo:"Diseño industrial",
            titulo:"Autobahn seating"
        }
    ])
